...
// Inline LandingPage component to avoid import issues
    ...
    <BrowserRouter>
      <div style={{ 
        ...
        <Routes>
          ...
          <Route path="/:code" element={<div style={{padding: '20px', textAlign: 'center', color: 'white'}}>Lobby Page - Coming Soon</div>} />
        </Routes>
      </div>
    </BrowserRouter>
  );
